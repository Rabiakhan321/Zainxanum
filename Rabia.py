...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Anum Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY ANUM X ZAIN \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          Hat mai phool hey koi asla to ni'
    print '         pkg krwao koi masla to nhi'
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
    print ' [1] START'
    print ' [2] FOLLOW ANUM SHEHZADI ON FB '
    print ' [3] CONTACT WITH MAI NHI BATONGI '
    print ''
    menu_option()
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Anum Shehzadi321')
        menu()
    elif select == '3':
